        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/profile" className="text-gray-300 hover:text-white text-sm">My Profile</Link></li>
              <li><Link to="/ambassadors" className="text-gray-300 hover:text-white text-sm">Ambassadors</Link></li>
              <li><Link to="/events" className="text-gray-300 hover:text-white text-sm">Cookie Events</Link></li>
              <li><Link to="/forum" className="text-gray-300 hover:text-white text-sm">Forum</Link></li>
              <li><Link to="/newsletter" className="text-gray-300 hover:text-white text-sm">Newsletter</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/link-to-us" className="text-gray-300 hover:text-white text-sm">Link to us</Link></li>
              <li><Link to="/sitemap" className="text-gray-300 hover:text-white text-sm">Site Map</Link></li>
            </ul>
          </div>
